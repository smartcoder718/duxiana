 ...
 * @source https://developer.bigcommerce.com/api-reference/f85142d05f305-get-a-product-variant-option
 * @returns {Promise} Promise object represents the result of the request
 */
export default async function handler(req, res) {
	try {
		const { product_id, option_id, exclude_fields, include_fields } = req.query;

		let endpoint = `/v3/catalog/products/${product_id}/options/${option_id}`;
