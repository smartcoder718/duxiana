 ...
 * @source https://developer.bigcommerce.com/api-reference/b3A6NDIxMTM2NjM-get-a-category
 * @returns {Promise} Promise object represents the result of the request
 */
export default async function handler(req, res) {
	try {
		const { category_id, exclude_fields, include_fields } = req.query;

		let endpoint = `/v3/catalog/categories/${category_id}`;
