 ...
 * @source https://developer.bigcommerce.com/api-reference/b3A6MzU5MDQzMDM-get-a-product-variant
 * @returns {Promise} Promise object represents the result of the request
 */
export default async function handler(req, res) {
	try {
		const { product_id, variant_id, exclude_fields, include_fields } = req.query;

		let endpoint = `/v3/catalog/products/${product_id}/variants/${variant_id}`;
