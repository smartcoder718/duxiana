 ...
 * @source https://docs.developers.optimizely.com/content-cloud/v1.5.0-content-delivery-api/reference/contentapi_getancestors
...
export default async function handler(req, res) {
	try {
		...
		let endpoint = `/v2.0/content/${content_reference}/ancestors`;
