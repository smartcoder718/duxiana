...
/**
 * @description Get the children of the content item with given language
 * @source https://docs.developers.optimizely.com/content-cloud/v1.5.0-content-delivery-api/reference/contentapi_getchildren
 * @return {Promise} Promise object represents the result of the request
 */
export default async function handler(req, res) {
	try {
		const { content_reference, expand, select, top, x_epi_continuation } = req.query;

		let endpoint = `/v2.0/content/${content_reference}/children`;
