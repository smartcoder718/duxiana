...
/**
 * @description Get the ancestors of the content item by given content reference or unique identifier and language.
 * @source https://docs.developers.optimizely.com/content-cloud/v1.5.0-content-delivery-api/reference/content_getancestors
...
export default async function handler(req, res) {
	try {
		...
		let endpoint = `/v2.0/content/${content_identifier}/ancestors`;
